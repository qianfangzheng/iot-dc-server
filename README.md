 ...
 :seedling: 为了便于你的二次开发和理解，`DC3` 开源了 `Demo Web UI` ，(微信号:17725354261 头条号：大数据java架构师 微信公众号:"前劲科技")
...
平台是基于 `Spring Cloud` 架构开发的,是一系列松耦合、开源的微服务集合。
...
(微信号:17725354261 头条号：大数据java架构师 微信公众号:"前劲科技")
